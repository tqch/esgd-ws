...
class ESGD:
    ...
    def train(self,train_data,train_targets):
        ...
        for g in range(self.n_generations):
            ...
            if self.verbose:
                print(f"Gen#{g}:")
                print(f"pre-SGD: {get_current_time()}")
            ...
            if self.verbose:
                print(f"post-SGD: {get_current_time()}")
                print(f"population average fitness: {sum(running_losses)/len(running_losses)}")
            if self.verbose:
                print(f"pre-EVO: {get_current_time()}")
            curr_mix = [
            ...
            others = np.random.choice(len(curr_gen)-self.m_elite, size=self.n_population-self.m_elite)+self.m_elite
            ...
            if self.verbose:
                print(f"post-EVO: {get_current_time()}")
                print(f"population average fitness: {sum(running_losses)/len(running_losses)}")
...
if __name__ == "__main__":
    ...
    esgd.train(train_data,train_targets)
